...
class FGVCAircraft(Dataset):
    ...
    **Description**
    ...
    TODO: Triantafillou et al. recommend cropping the images using the bounding box information, to remove copyright information and ensure that only one plane is visible in the image.
