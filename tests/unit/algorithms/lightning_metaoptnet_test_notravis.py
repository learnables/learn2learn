...
from learn2learn.algorithms import LightningMetaOptNet


class TestLightningMetaOptNet(unittest.TestCase):

    def test_metaoptnet(self):
        meta_batch_size = 4
        max_epochs = 20
        seed = 42
        ways = 5
        ...
        metaoptnet = LightningMetaOptNet(features, lr=3e-4)
        ...
        self.assertTrue(acc[0]["valid_accuracy"] >= 0.25)
